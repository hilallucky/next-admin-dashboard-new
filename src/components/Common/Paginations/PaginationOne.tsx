                ...
                <div className="flex flex-wrap items-center lg:justify-between md:justify-between sm:justify-start ">
                    <div>
                        <p className="text-sm text-gray-700">
                            Showing
                            <span className="font-medium px-1">{totalPages === page ? (totalRecords - rowsPerPage) + 1 : (page === 1 ? 1 : (page - 1) * rowsPerPage + 1)}</span>
                            to
                            <span className="font-medium px-1">{totalPages === page ? totalRecords : page * rowsPerPage}</span>
                            of
