...
import { AiFillIdcard, AiOutlineClockCircle, AiOutlineClose, AiOutlineCloseCircle, AiOutlineHome, AiOutlineMail, AiOutlineMobile, AiOutlinePhone, AiOutlineQrcode, AiOutlineRest, AiOutlineUser } from 'react-icons/ai';
...
import { useSupplierDelete } from '@/fetchers/Suppliers';
                        ...
                        <div className="w-full px-3 2xsm:w-1/2">
                            ...
                            >
                                <div className='flex items-center justify-center'>
                                    ...
                                    <span className='px-4'>Delete {supplier?.id}</span>
                                </div>
                            </MyButton>
                        </div>
                    </div>
