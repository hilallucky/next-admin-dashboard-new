...
import { EditButton, DeleteButton } from "@components/Common/Button/NewButton";

const SupplierDataTabel = async ({
    query,
    currentPage,
}: {
    query: string;
            ...
            <tbody>
                {contacts.map((contact, index) => (
                    <tr key={contact.id} className="bg-white border-b">
                        ...
                        <td className="py-3 px-6">{contact.officePhone}</td>
...
export default SupplierDataTabel;