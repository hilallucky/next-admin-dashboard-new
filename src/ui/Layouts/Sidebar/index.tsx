...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const supplierPath = `/dashboard/supplier`;
  const product = `product`;
  const productPath = `/dashboard/product`;
  const customer = `/dashboard/customer`;
  const customerPath = `/dashboard/customer`;
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <!-- Start Menu DATA MASTER Item for My Dashboard --> */}
              {/* <!-- Start Data User --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes(userPath)
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <GoPerson size={20} className={`fill-current`} />
                        User
                        <GoChevronUp
                          size={20}
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === `/${supplierPath}` ||
                  pathname.includes(supplierPath)
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href={`${supplierPath}/new`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${supplierPath}/new` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlinePlusCircle
                          ...
                          <li>
                            <Link
                              href={`${supplierPath}/list`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${supplierPath}/list` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlineOrderedList
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <GoPackage size={20} className={`fill-current`} />
                        Product
                        <GoChevronUp
                          size={20}
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href={`${productPath}/new`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${productPath}/new` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlinePlusCircle
                          ...
                          <li>
                            <Link
                              href={`${productPath}/list`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${productPath}/list` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlineOrderedList
              ...
              <SidebarLinkGroup
                activeCondition={
                  ...
                  pathname.includes(customerPath)
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <GoPeople size={20} className={`fill-current`} />
                        Customer
                        <GoChevronUp
                          size={20}
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href={`${customerPath}/new`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${customerPath}/new` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlinePlusCircle
                          ...
                          <li>
                            <Link
                              href={`${customerPath}/list`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === `${customerPath}/list` &&
                                'text-white'
                              }`}
                            >
                              <AiOutlineOrderedList
              ...
              {/* <!-- End Data Customer --> */}
              {/* <!-- End Menu DATA MASTER Item for My Dashboard --> */}
            </ul>
          </div>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname ===
                                  '/dashboard/forms/product-maintenance' &&
                                'text-white'
                              }`}
                            >
