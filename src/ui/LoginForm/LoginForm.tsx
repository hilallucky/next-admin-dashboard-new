...
const LoginForm: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="h-full w-full md:h-full flex flex-wrap justify-center items-center xl:bg-black md:bg-none ">
        <div className="w-96 h-full md:h-full m-10 rounded-lg border border-stroke bg-white shadow-default md:bg-none dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            <div className="w-96 h-3/6 border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-96 h-3/6 p-4 sm:p-12.5 xl:p-17.5">
