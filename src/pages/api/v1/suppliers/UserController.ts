  ...
  try {
    ...
    if (!users) {
      return res
        .status(404)
        .send(
          Helper.ResponseData(res.statusCode, 'User not found', null, null),
        );
    }

    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'OK', null, users));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const RegisterUser = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res
      .status(201)
      .send(Helper.ResponseData(res.statusCode, 'Created', null, create));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const LoginUser = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    if (!user.active) {
      return res
        .status(401)
        .send(Helper.ResponseData(401, '', 'User not verified', null));
    }

    const isMatch = await PasswordHelper.PasswordCompare(
      password,
      user.password,
    );
    if (!isMatch) {
    ...
    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'OK', null, dataUser));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const UserDetail = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'OK', null, user));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const UserLogout = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'User logout', null, null));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const UpdateUser = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'Updated', null, user));
  } catch (error) {
    return res
      .status(500)
      .send(
...
const DeleteUser = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res
      .status(200)
      .send(Helper.ResponseData(res.statusCode, 'Deleted', null, user));
  } catch (error) {
    return res
      .status(500)
      .send(
